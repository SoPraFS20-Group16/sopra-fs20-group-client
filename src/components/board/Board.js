...
export default class Board extends React.Component {
  ...
  randomImage() {
    ...
    const ore =
      'https://purepng.com/public/uploads/large/purepng.com-mountainmountainlarge-landformmountain-peakvolcanic-mountainfold-mountainblock-ore-1411527067889ftubz.png';
  ...
  randomNumber() {
    ...
    const number2 =
      'https://cdn.clipart.email/f78357664d2afe5d3b1cca9b8b483eec_2-icon-transparent-png-clipart-free-download-ywd_1600-1600.png';
    const number3 =
  ...
  createBoard() {
    ...
    */
    ...
    for (let left = 2; left <= 6; left += 2) {
      ...
      hexes.push(
        <Hex
          {...this.coordTrans({ x: left, y: 0, radius: 50 })}
          img={images[i]}
          numberImg={numberImg[j]}
          number={this.getNumber(numberImg[j])}
        />
      );
    }
    ...
    for (let left = 1; left <= 7; left += 2) {
      ...
      hexes.push(
        <Hex
          {...this.coordTrans({ x: left, y: 2, radius: 50 })}
          img={images[i]}
          numberImg={numberImg[j]}
          number={this.getNumber(numberImg[j])}
        />
    ...
    for (let left = 0; left <= 2; left += 2) {
      ...
      hexes.push(
        <Hex
          {...this.coordTrans({ x: left, y: 4, radius: 50 })}
          img={images[i]}
          numberImg={numberImg[j]}
          number={this.getNumber(numberImg[j])}
        />
    ...
    hexes.push(
      <Hex
        {...this.coordTrans({ x: 4, y: 4, radius: 50 })}
        img='https://purepng.com/public/uploads/large/desert-9hl.png'
        numberImg='https://www.kindpng.com/picc/b/133/1338575.png'
      />
    );
    ...
    for (let left = 1; left <= 7; left += 2) {
      ...
      hexes.push(
        <Hex
          {...this.coordTrans({ x: left, y: 6, radius: 50 })}
          img={images[i]}
          numberImg={numberImg[j]}
          number={this.getNumber(numberImg[j])}
        />
    ...
    for (let left = 2; left <= 6; left += 2) {
      ...
      hexes.push(
        <Hex
          {...this.coordTrans({ x: left, y: 8, radius: 50 })}
          img={images[i]}
          numberImg={numberImg[j]}
          number={this.getNumber(numberImg[j])}
        />
